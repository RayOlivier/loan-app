  ...
  return (
    <div className="loan-data">
      <div className="loan-data__numbers">
        <div className="loan-data__monthly">Monthly Payment: ${loanCalculations && getUSD(loanCalculations?.monthlyPayment)} </div>
        <br />
        <div className="loan-data__principal">Loan Principal: ${loanCalculations && getUSD(loanCalculations?.principal)}</div>
        <div className="loan-data__tax">Sales Tax: ${loanCalculations && getUSD(loanCalculations?.salesTax)}</div>
        <div className="loan-data__upfront">Upfront Cost: ${loanCalculations && getUSD(loanCalculations?.upfrontCost)}</div>
        <br />
        <div className="loan-data__interest">Total Interest: ${loanCalculations && getUSD(loanCalculations?.totalInterest)}</div>
        <div className="loan-data__payments-total">
          Total of {loanData ? loanData.termMonths : 'Loan'} Payments: ${loanCalculations && getUSD(loanCalculations?.totalLoan)}
        </div>
        <div className="loan-data__total-cost">Total Cost: ${loanCalculations && getUSD(loanCalculations?.totalCost)}</div>
      </div>
